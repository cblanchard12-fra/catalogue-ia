...
export const STORAGE_KEY = 'ia-portfolio-data-v1';

export const STATUS_LIST = ['Déployé', 'En test', 'À tester', 'Non évalué'];
export const RISK_LIST = ['Faible', 'Moyen', 'Élevé', 'À évaluer'];
export const MOSCOW_LIST = ['Must', 'Should', 'Could', "Won't", 'À qualifier'];
export const LEVEL_LIST = ['L1', 'L2', 'L3', 'L4'];
export const SOUVERAINETE_LIST = ['Souverain', 'Non souverain', 'Interne', 'À définir'];
...
export const DOC_CATEGORIES = ['Présentations', 'Cas clients', "Retours d'expérience", 'Documentation technique', 'Liens utiles'];
...
export function seedInitiatives() {
...
export function saveData(initiatives) {
  try {
...
export function makeId() { return uid('ini'); }
...
export function computePriority(ini) {
...
export function buildDefaultPortfolioSchema(initiatives) {
...
export function savePortfolioSchema(schema) {
  try {
...
export const CUSTOM_WIDGETS_KEY = 'ia-portfolio-custom-widgets-v1';
export const WIDGET_FORMATS = ['donut', 'bar', 'kpi'];
export const WIDGET_DIMENSIONS = ['status', 'risk', 'priority', 'domain', 'moscow', 'souverainete'];
...
export function badgePalette() { return BADGE_PALETTE; }
export const MARKER_COLORS = ['#2454C7', '#1E8E5A', '#B9770E', '#C23B3B', '#7A3FC2', '#1F7A8C', '#0B7285', '#9C36B5', '#E8590C', '#2F9E44', '#1864AB', '#D6336C', '#5F3DC4', '#087F5B', '#862E9C', '#5C6B84'];
export const MARKER_SYMBOLS = ['●', '■', '▲', '◆', '★', '✦', '⬟', '⬢', '✚', '✓', '!', '⚑', '⚙', '⚡', '☎', '🔒', '🌐', '🧠', '🤖', '📊'];
export function editorBadgeColor(name) {
  const s = String(name || '');
  let h = 0;
